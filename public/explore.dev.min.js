...
var Scene = (function (Serializable$$1) {
	...
	Scene.prototype.init = function init () {
		...
		this.deleteChildren();
		game.forEachChild('prt', function (p) { return p.name !== 'Player' && this$1.spawn(p); }, true);
	};
	Scene.prototype.play = function play () {
		...
		var player = game.findChild('prt', function (p) { return p.name === 'Player'; }, true);
		if (player) {
...
setTimeout(function () {
	...
	socket.on('shareScene', function (sceneStr) {
