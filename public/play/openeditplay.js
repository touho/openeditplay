(function (factory) {
    ...
    */
    ...
    eventDispatcherCallbacks.eventDispatchedCallback = function (eventName, count) { return eventHappened("Event " + eventName); };
    function start(name) {
        // @ifndef OPTIMIZE
    ...
    */
    ...
    var controlArray = Object.keys(controls).map(function (key) { return controls[key]; });
